...
<footer class="bg-black mt-8 text-white">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <img src="logo2.jpg" class="h-7 me-3" alt="X2ls Logo" />
                  <span class="text-heading self-center  whitespace-nowrap">an audio plugins company</span>
              </a>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-body sm:text-center">© 2025 <a href="https://flowbite.com/" class="hover:underline">X2LS™</a>. All Rights Reserved.
          </span>
          <div class="flex mt-4 sm:justify-center sm:mt-0">
         <a href="https://www.instagram.com/xtwols/" class="text-body hover:text-heading">
  <svg
    class="w-5 h-5"
    aria-hidden="true"
  ...
  >
    <path
      fill-rule="evenodd"
      d="M7 2a5 5 0 0 0-5 5v10a5 5 0 0 0 5 5h10a5 5 0 0 0 5-5V7a5 5 0 0 0-5-5H7Zm10 2H7a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V7a3 3 0 0 0-3-3Zm-5 4a5 5 0 1 0 0 10 5 5 0 0 0 0-10Zm0 2a3 3 0 1 1 0 6 3 3 0 0 1 0-6Zm5.25-.75a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"
      clip-rule="evenodd"
    />
  </svg>
